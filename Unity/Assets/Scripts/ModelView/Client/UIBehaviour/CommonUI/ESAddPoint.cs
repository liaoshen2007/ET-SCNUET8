		...
		public Button EButton_AddPointButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_EButton_AddPointButton = UIFindHelper.FindDeepChild<Button>(this.uiTransform.gameObject,"Root/EButton_AddPoint");
     			}
		...
		public Button EButton_ReducePointButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_EButton_ReducePointButton = UIFindHelper.FindDeepChild<Button>(this.uiTransform.gameObject,"Root/EButton_ReducePoint");
     			}
		...
		public ExtendText E_AddPointExtendText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_AddPointExtendText = UIFindHelper.FindDeepChild<ExtendText>(this.uiTransform.gameObject,"Root/E_AddPoint");
     			}
