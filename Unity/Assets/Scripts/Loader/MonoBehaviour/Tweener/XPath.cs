...
namespace ET
{
    ...
    public struct XPathPoint
    {
        ...
        public XPathPoint(Vector3 pos, Vector3 control)
        {
            this.pos = pos;
            control1 = control;
            control2 = Vector3.zero;
        ...
        public XPathPoint(Vector3 pos, Vector3 control1, Vector3 control2)
        {
            this.pos = pos;
        ...
        public XPathPoint(Vector3 pos, CurveType curveType)
        {
            this.pos = pos;
            control1 = Vector3.zero;
            control2 = Vector3.zero;
    ...
    public class XPath
    {
        ...
        {
            public XPathPoint.CurveType type;
            public float length;
            public int ptStart;
            public int ptCount;
        }
        ...
        static List<XPathPoint> helperList = new List<XPathPoint>();
        ...
        public void Create(XPathPoint pt1, XPathPoint pt2)
        {
            helperList.Clear();
            helperList.Add(pt1);
            helperList.Add(pt2);
        ...
        public void Create(XPathPoint pt1, XPathPoint pt2, XPathPoint pt3)
        {
            helperList.Clear();
            helperList.Add(pt1);
            helperList.Add(pt2);
        ...
        public void Create(XPathPoint pt1, XPathPoint pt2, XPathPoint pt3, XPathPoint pt4)
        {
            helperList.Clear();
            helperList.Add(pt1);
            helperList.Add(pt2);
        ...
        public void Create(IEnumerable<XPathPoint> points)
        {
            _segments.Clear();
            _points.Clear();
            splinePoints.Clear();
            ...
            et.Dispose();
            XPathPoint prev = et.Current;
            if (prev.curveType == XPathPoint.CurveType.CRSpline)
                splinePoints.Add(prev.pos);

            while (et.MoveNext())
            {
                XPathPoint current = et.Current;
                ...
                if (prev.curveType != XPathPoint.CurveType.CRSpline)
                {
                    ...
                    if (prev.curveType == XPathPoint.CurveType.Straight)
                    {
                        seg.ptCount = 2;
                        _points.Add(prev.pos);
                        _points.Add(current.pos);
                    }
                    else if (prev.curveType == XPathPoint.CurveType.Bezier)
                    {
                        seg.ptCount = 3;
                        _points.Add(prev.pos);
                        _points.Add(current.pos);
                    ...
                    else if (prev.curveType == XPathPoint.CurveType.CubicBezier)
                    {
                        seg.ptCount = 4;
                        _points.Add(prev.pos);
                        _points.Add(current.pos);
                ...
                if (current.curveType != XPathPoint.CurveType.CRSpline)
                {
        ...
        void CreateSplineSegment()
        {
            ...
            Segment seg = new Segment();
            seg.type = XPathPoint.CurveType.CRSpline;
            seg.ptStart = _points.Count;
            seg.ptCount = cnt;
        ...
        public Vector3 GetPointAt(float t)
        {
            ...
            if (t == 1)
            {
                ...
                if (seg.type == XPathPoint.CurveType.Straight)
                    return Vector3.Lerp(_points[seg.ptStart], _points[seg.ptStart + 1], t);
                else if (seg.type == XPathPoint.CurveType.Bezier || seg.type == XPathPoint.CurveType.CubicBezier)
