...
{
    [Config]
    public partial class BuffCfgCategory : Singleton<BuffCfgCategory>, IMerge
    {
        [BsonElement]
        [BsonDictionaryOptions(DictionaryRepresentation.ArrayOfArrays)]
        private Dictionary<int, BuffCfg> dict = new();
		
        public void Merge(object o)
        {
            BuffCfgCategory s = o as BuffCfgCategory;
        ...
        {
            this.dict.TryGetValue(id, out BuffCfg item);

            if (item == null)
            {
                throw new Exception($"配置找不到，配置表名: {nameof (BuffCfg)}，配置id: {id}");
            }
        ...
        public Dictionary<int, BuffCfg> GetAll()
        {
            return this.dict;
        }

        public BuffCfg GetOne()
        {
	...
	public partial class BuffCfg: ProtoObject, IConfig
	{
		/// <summary>ID</summary>
