...
{
    [Config]
    public partial class BuffCategory : Singleton<BuffCategory>, IMerge
    {
        [BsonElement]
        [BsonDictionaryOptions(DictionaryRepresentation.ArrayOfArrays)]
        private Dictionary<int, Buff> dict = new();
		
        public void Merge(object o)
        {
            BuffCategory s = o as BuffCategory;
        ...
        {
            this.dict.TryGetValue(id, out Buff item);

            if (item == null)
            {
                throw new Exception($"配置找不到，配置表名: {nameof (Buff)}，配置id: {id}");
            }
        ...
        public Dictionary<int, Buff> GetAll()
        {
            return this.dict;
        }
	...
	public partial class Buff: ProtoObject, IConfig
	{
		/// <summary>ID</summary>
