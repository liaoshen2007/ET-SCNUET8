...
namespace ET
{
    ...
    {
        private readonly Dictionary<string, ACmdHandler> cmdHandlers = new Dictionary<string, ACmdHandler>();
        ...
        /// <returns></returns>
        public MessageReturn ProcessCmdList(Unit self, List<CmdArg> list, List<long> args = default, bool errorContinue = false)
        {
