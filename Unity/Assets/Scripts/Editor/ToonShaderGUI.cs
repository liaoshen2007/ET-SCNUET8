...
public class ToonShaderGUI : ShaderGUI 
{
    ...
    public override void OnGUI (MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        //_shadingStyle = (ShadingStyle)materialEditor.(FindProperty("_SHADING_STYLE", properties), new GUIContent("Material"), options);
        ...
        _shadingStyle = ShadingStyle.SkinAndTextiles;
